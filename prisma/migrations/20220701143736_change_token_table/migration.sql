/*
  ...
  - You are about to drop the column `vestingtest` on the `easytokens` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "easytokens" DROP COLUMN "vestingtest",
ADD COLUMN     "vestingeight" DATE NOT NULL,
