...
dynamic(
    () => {
         ...
         * @version 1.2.0
         */
        ! function() { "use strict"; var t, e, r, a, n, o;
            null !== (e = document.querySelector('[data-bs-toggle="mode"]')) && (t = e.querySelector(".form-check-input"), "dark" === mode ? (root.classList.add("dark-mode"), t.checked = !0) : (root.classList.remove("dark-mode"), t.checked = !1), e.addEventListener("click", function(e) { t.checked ? (root.classList.add("dark-mode"), window.localStorage.setItem("mode", "dark")) : (root.classList.remove("dark-mode"), window.localStorage.setItem("mode", "light")) })), null != (a = document.querySelector(".navbar-sticky")) && (e = a.classList, r = a.offsetHeight, e.contains("position-absolute") ? window.addEventListener("scroll", function(e) { 500 < e.currentTarget.pageYOffset ? a.classList.add("navbar-stuck") : a.classList.remove("navbar-stuck") }) : window.addEventListener("scroll", function(e) { 500 < e.currentTarget.pageYOffset ? (document.body.style.paddingTop = r + "px", a.classList.add("navbar-stuck")) : (document.body.style.paddingTop = "", a.classList.remove("navbar-stuck")) })), new SmoothScroll("[data-scroll]", { speed: 800, speedAsDuration: !0, offset: function(e, t) { return t.dataset.scrollOffset || 40 }, header: "[data-scroll-header]", updateURL: !1 }), null != (o = document.querySelector(".btn-scroll-top")) && (n = parseInt(600, 10), window.addEventListener("scroll", function(e) { e.currentTarget.pageYOffset > n ? o.classList.add("show") : o.classList.remove("show") })),
                ...
                function() { for (var e = document.querySelectorAll(".swiper"), t = function(e, t) {
                            (r = null != t.dataset.swiperOptions ? JSON.parse(t.dataset.swiperOptions) : r).pager && (a = { pagination: { el: ".pagination .list-unstyled", clickable: !0, bulletActiveClass: "active", bulletClass: "page-item", renderBullet: function(e, t) { return '<li class="' + t + '"><a href="#" class="page-link btn-icon btn-sm">' + (e + 1) + "</a></li>" } } }); var r, a = _objectSpread(_objectSpread({}, r), a),
                                t = new Swiper(t, a);
                            r.tabs && t.on("activeIndexChange", function(e) { var t = document.querySelector(e.slides[e.activeIndex].dataset.swiperTab);
                                document.querySelector(e.slides[e.previousIndex].dataset.swiperTab).classList.remove("active"), t.classList.add("active") }) }, r = void 0, a = 0; a < e.length; a++) t.call(r, a, e[a]) }(),
                function() { var e = document.querySelectorAll(".gallery"); if (e.length)
                        for (var t = 0; t < e.length; t++) { var r = !!e[t].dataset.thumbnails,
                                ...
                                r = r ? [lgThumbnail] : [],
                                n = [].concat(n, a, r);
                            lightGallery(e[t], { selector: ".gallery-item", plugins: n, licenseKey: "D4194FDD-48924833-A54AECA3-D6F8E646", download: !1, autoplayVideoOnSlide: !0, zoomFromOrigin: !1, youtubePlayerParams: { modestbranding: 1, showinfo: 0, rel: 0 }, vimeoPlayerParams: { byline: 0, portrait: 0, color: "6366f1" } }) } }(),
                ...
                function() { var a = document.querySelectorAll("[data-format]"); if (0 !== a.length)
                        for (var e = 0; e < a.length; e++) ! function(e) { var e = a[e],
                                t = e.parentNode.querySelector(".credit-card-icon"),
                                r = void 0;
                            null != e.dataset.format && (r = JSON.parse(e.dataset.format)), t ? new Cleave(e, _objectSpread(_objectSpread({}, r), {}, { onCreditCardTypeChanged: function(e) { t.className = "credit-card-icon " + e } })) : new Cleave(e, r) }(e) }(), [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]')).map(function(e) { return new bootstrap.Tooltip(e, { trigger: "hover" }) }), [].slice.call(document.querySelectorAll('[data-bs-toggle="popover"]')).map(function(e) { return new bootstrap.Popover(e) }), [].slice.call(document.querySelectorAll(".toast")).map(function(e) { return new bootstrap.Toast(e) }),
                ...
                function() { var l = document.querySelectorAll(".subscription-form"); if (null !== l) { for (var e = 0; e < l.length; e++) ! function(e) { var t = l[e].querySelector('button[type="submit"]'),
                            ...
                            l[e].addEventListener("submit", function(e) { e && e.preventDefault(), "" === n.value && s(this, t, a, r, o) }) }(e); var s = function(e, t, r, a, n) { t.innerHTML = "Sending..."; var e = e.action.replace("/post?", "/post-json?"),
                ...
                function() { var v = document.querySelectorAll(".audio-player"); if (0 !== v.length)
                        for (var e = function(e) {
                                function t(e) { e === i ? l.style.setProperty("--seek-before-width", e.value / e.max * 100 + "%") : l.style.setProperty("--volume-before-width", e.value / e.max * 100 + "%") }

                                function r(e) { var t = Math.floor(e / 60),
                                        e = ((e = Math.floor(e % 60)) < 10 ? "0" : "").concat(e); return "".concat(t, ":").concat(e) }

                                function a() { u.textContent = r(s.duration) }

                                function n() { i.max = Math.floor(s.duration) }

                                function o() { var e = Math.floor(s.buffered.end(s.buffered.length - 1));
                                    l.style.setProperty("--buffered-width", "".concat(e / i.max * 100, "%")) } var l = v[e],
                                    s = l.querySelector("audio"),
                                    e = l.querySelector(".ap-play-button"),
                                    i = l.querySelector(".ap-seek-slider"),
                                    c = l.querySelector(".ap-volume-slider"),
                                    u = l.querySelector(".ap-duration"),
                                    d = l.querySelector(".ap-current-time"),
                                    p = "play",
                                    f = null,
                                    m = (e.addEventListener("click", function(e) { p = "play" === p ? (e.currentTarget.classList.add("ap-pause"), s.play(), requestAnimationFrame(m), "pause") : (e.currentTarget.classList.remove("ap-pause"), s.pause(), cancelAnimationFrame(f), "play") }), i.addEventListener("input", function(e) { t(e.target) }), c.addEventListener("input", function(e) { t(e.target) }), function e() { i.value = Math.floor(s.currentTime), d.textContent = r(i.value), l.style.setProperty("--seek-before-width", "".concat(i.value / i.max * 100, "%")), f = requestAnimationFrame(e) });
                                0 < s.readyState ? (a(), n(), o()) : s.addEventListener("loadedmetadata", function() { a(), n(), o() }), s.addEventListener("progress", o), i.addEventListener("input", function() { d.textContent = r(i.value), s.paused || cancelAnimationFrame(f) }), i.addEventListener("change", function() { s.currentTime = i.value, s.paused || requestAnimationFrame(m) }), c.addEventListener("input", function(e) { e = e.target.value;
                                    s.volume = e / 100 }) }, t = 0; t < v.length; t++) e(t) }() }();
    }, { ssr: false }
);